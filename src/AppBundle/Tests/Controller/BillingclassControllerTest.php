...
class BillingclassControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/billingclass/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'billingclass[name]' => 'Lorem ipsum dolor sit amet',
            'billingclass[coeff]' => 10.99,
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/billingclass/new');
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'billingclass_filter[name]' => 'First%',
            'billingclass_filter[coeff]' => 10.99,
